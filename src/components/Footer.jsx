        ...
        <div className="flex-container">
          <div className="text-center lg:text-left mb-8 lg:mb-0 flex flex-col gap-8">
            ...
            <div className="text-myCustomColor-light">
              <p>Suport@getNile.com</p>
              <p className="font-bold mt-4">+234 456 789 xxx</p>
            </div>
            <form>
              <input type="text" className=" text-pry1 w-inputW' py-3 pl-2 rounded-l-md outline-none focus:outline focus:outline-myCustomColor-light"  name="footer-input" id="footer-input" placeholder="Enter your Name" />
